...
const IssuePage = async ({ params }: { params: Promise<{ id: string }> }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8">
      ...
      <div className="bg-gray-900 dark:bg-dark-elevated border border-gray-700 dark:border-dark-border-default rounded-lg shadow-sm p-6 mb-8">
      ...
      <div className="bg-gray-900 dark:bg-dark-elevated border border-gray-700 dark:border-dark-border-default rounded-lg shadow-sm p-6">
        <h2 className="text-lg font-medium mb-2 text-gray-400 dark:text-gray-400">Details</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-500">{formatRelativeTime(new Date(createdAt))}</p>
          </div>
        </div>
      </div>
    </div>
